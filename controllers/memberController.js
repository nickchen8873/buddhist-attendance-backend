...
exports.createMember = async (req, res) => {
  try {
    const { name, dharma_name, gender, phone, birthday, address, status, group, role, telephone, remark} = req.body;
    const pool = await sql.connect(config);
    ...
    const result = await pool.request()
      ...
      .query(`INSERT INTO members 
        (name, dharma_name, gender, phone, birthday, address, status, role, [group], telephone, remark, created_at)
        VALUES (@name, @dharma_name, @gender, @phone, @birthday, @address, @status, @role, @group, @telephone, @remark, @created_at)
